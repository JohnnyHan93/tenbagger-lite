...
export const ENGINE_TAB = {
  xbagger: { id: "x" as const, name: "X-Bagger", version: "XBG-v2.3" },
  oversold: { id: "o" as const, name: "Oversold", version: "OSM-v2.3" },
  quality: { id: "q" as const, name: "Quality 70", version: "MFC70-v1.4" },
};
