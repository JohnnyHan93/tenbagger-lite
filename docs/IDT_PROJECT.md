...
작성: 2026-09-14. 이 파일이 제품·구조·배포·데이터·기준 변경의 한 장 요약이다. 세부 엔진 문서는 아래 [문서 인덱스](#문서-인덱스)로 간다.
...
|---|---|
| 제품명 | IDT 투자발견 |
| 리포 | [JohnnyHan93/tenbagger-lite](https://github.com/JohnnyHan93/tenbagger-lite) |
